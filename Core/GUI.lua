...
local function CreateIndicatorSettings(containerParent, unit)
    ...
    EnableTargetCheckBox:SetCallback("OnValueChanged", function(_, _, value) IndicatorsDB.TargetIndicator.Enabled = value UUF:UpdateUnitFrame(unit) DeepDisable(TargetIndicatorContainer, not IndicatorsDB.TargetIndicator.Enabled, EnableTargetCheckBox) end)
    ...
    ColourPickerTarget:SetCallback("OnValueChanged", function(_, _, r, g, b, a) IndicatorsDB.TargetIndicator.Colour = {r, g, b, a} UUF:UpdateUnitFrame(unit) end)
    ...
    IndicatorStyleDropdown:SetCallback("OnValueChanged", function(_, _, value) IndicatorsDB.TargetIndicator.Style = value UUF:UpdateUnitFrame(unit) end)
