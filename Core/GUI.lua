...
local function CreateUnitFrameFrameSettings(containerParent, unit)
    ...
    EnableUnitFrame:SetRelativeWidth(isPlayerorTarget and 0.2 or 0.25)
    ...
    ClassColourCheckBox:SetRelativeWidth(isPlayerorTarget and 0.2 or 0.25)
    ...
    ReactionColourCheckBox:SetRelativeWidth(isPlayerorTarget and 0.2 or 0.25)
    ...
    local InverseHealthBarCheckBox = AG:Create("CheckBox")
    InverseHealthBarCheckBox:SetLabel("Inverse Health Bar")
    InverseHealthBarCheckBox:SetValue(FrameDB.InverseHealthBar)
    InverseHealthBarCheckBox:SetRelativeWidth(isPlayerorTarget and 0.2 or 0.25)
    InverseHealthBarCheckBox:SetCallback("OnValueChanged", function(_, _, value) FrameDB.InverseHealthBar = value if unit == "boss" then UUF:UpdateAllBossFrames() else if unit == "boss" then UUF:UpdateAllBossFrames() else UUF:UpdateUnitFrame(unit) end  end  end)
    TogglesContainer:AddChild(InverseHealthBarCheckBox)
    ...
    if isPlayerorTarget then
        ...
        AnchorToEssentialCooldownsCheckBox:SetRelativeWidth(0.2)
