...
local function CreateUnitFrameFrameSettings(containerParent, unit)
    ...
    EnableUnitFrame:SetRelativeWidth(isPlayerorTarget and 0.33 or 0.25)
    ...
    ClassColourCheckBox:SetRelativeWidth(isPlayerorTarget and 0.33 or 0.25)
    ...
    ReactionColourCheckBox:SetRelativeWidth(isPlayerorTarget and 0.33 or 0.25)
    ...
    InverseGrowthCheckBox:SetValue(FrameDB.InverseGrowth)
    InverseGrowthCheckBox:SetRelativeWidth(isPlayerorTarget and 0.5 or 0.25)
    InverseGrowthCheckBox:SetCallback("OnValueChanged", function(_, _, value) FrameDB.InverseGrowth = value if unit == "boss" then UUF:UpdateAllBossFrames() else if unit == "boss" then UUF:UpdateAllBossFrames() else UUF:UpdateUnitFrame(unit) end  end  end)
    InverseGrowthCheckBox:SetCallback("OnEnter", function() GameTooltip:SetOwner(InverseGrowthCheckBox.frame, "ANCHOR_CURSOR") GameTooltip:AddLine("|cFF8080FFInverse Growth|r will adjust the growth direction from |cFFFFCC00Right to Left|r to |cFFFFCC00Left to Right|r", 1, 1, 1) GameTooltip:Show() end)
    ...
    if isPlayerorTarget then
        ...
        AnchorToEssentialCooldownsCheckBox:SetRelativeWidth(0.5)
    ...
    if isBoss then
        ...
        SpacingSlider:SetSliderValues(-3, 500, 0.1)
...
local function CreateAlternatePowerBarSettings(containerParent, unit)
    ...
    local InverseGrowthCheckBox = AG:Create("CheckBox")
    InverseGrowthCheckBox:SetLabel("Inverse Growth")
    InverseGrowthCheckBox:SetValue(AlternatePowerBarDB.InverseGrowth)
    InverseGrowthCheckBox:SetRelativeWidth(0.33)
    InverseGrowthCheckBox:SetCallback("OnValueChanged", function(_, _, value) AlternatePowerBarDB.InverseGrowth = value if unit == "boss" then UUF:UpdateAllBossFrames() else UUF:UpdateUnitFrame(unit) end  end)
    InverseGrowthCheckBox:SetCallback("OnEnter", function() GameTooltip:SetOwner(InverseGrowthCheckBox.frame, "ANCHOR_CURSOR") GameTooltip:AddLine("|cFF8080FFInverse Health Bar|r will adjust the growth direction from |cFFFFCC00Right to Left|r to |cFFFFC00Left to Right|r", 1, 1, 1) GameTooltip:Show() end)
    InverseGrowthCheckBox:SetCallback("OnLeave", function() GameTooltip:Hide() end)
    TogglesContainer:AddChild(InverseGrowthCheckBox)
...
local function CreateCastBarSettings(containerParent, unit)
    ...
    NotInterruptibleColourPicker:SetCallback("OnValueChanged", function(_, _, r, g, b, a) CastBarDB.NotInterruptibleColour = {r, g, b, a} if unit == "boss" then UUF:UpdateAllBossFrames() else UUF:UpdateUnitFrame(unit) end  end)
    ColoursContainer:AddChild(NotInterruptibleColourPicker)
...
function UUF:CreateGUI()
    ...
    GUIFrame:SetStatusText(UUF.Version)
    ...
    local function DrawGeneralSettings(Container)
        ...
        SupportMeContainer:SetTitle("How To Support " .. UUF.AddOnName .. " Development")
    ...
    local function DrawProfileSettings(GUIContainer)
        ...
        if C_AddOns.IsAddOnLoaded("FragUI") then
            local FragUIContainer = CreateInlineGroup(ScrollFrame, "|TInterface\\AddOns\\FragUI\\Media\\Logo_Small.png:16:16|t|cFF8080FFFrag|rUI")
            local FragUIInfo = CreateInfoTag("Import |cFFFFCC00FragUI|r Themes into |cFF8080FFUnhalted Unit Frames|r.")

            FragUIInfo:SetRelativeWidth(1)
            FragUIContainer:AddChild(FragUIInfo)

            local FragUIDarkModeButton = AG:Create("Button")
