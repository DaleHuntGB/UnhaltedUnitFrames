...
function UUF:CreateGUI()
    ...
    local function DrawProfileSettings(GUIContainer)
        ...
        if C_AddOns.IsAddOnLoaded("FragUI") then
            ...
            FragUIDarkModeButton:SetCallback("OnClick", function() UUF:ImportSavedVariables(FragUIG:ImportProfile("Dark"), "FragUI - Dark") end)
            ...
            FragUIColourModeButton:SetCallback("OnClick", function() UUF:ImportSavedVariables(FragUIG:ImportProfile("Colour"), "FragUI - Colour") end)
