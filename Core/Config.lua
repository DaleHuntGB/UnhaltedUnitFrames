...
local function RandomizeStatusText()
    local SupportOptions = {
        ...
        "|cFF8080FFSupport|r is truly appreciated |T" .. EMOTE_PATH .. "peepoLove.png:18:18|t " .. "|cFF8080FFDevelopment|r takes time & effort."
    }
    ...
    function SelectedGroup(GUIContainer, _, mainGroup)
        ...
        local function DrawUnitContainer(GUIContainer, unit)
            ...
            local function DrawPowerBarContainer(GUIContainer)
                ...
                GUIContainer:AddChild(PowerBarColourPickerContainer)
                ...
                GUIContainer:AddChild(PowerBarPositionContainer)
            ...
            local function DrawTagsContainer(GUIContainer)
                ...
                local function SelectedTagGroup(GUIContainer, _, tagGroup)
                    ...
                    local function DrawFirstTagContainer()
                        ...
                        GUIContainer:AddChild(FirstTagOffsetX)
                        ...
                        GUIContainer:AddChild(FirstTagOffsetY)
                        ...
                        GUIContainer:AddChild(FirstTagFontSize)
                        ...
                        GUIContainer:AddChild(FirstTagColour)

                        local FirstTagText = CreateTag("Tag", Tags.First.Tag, unit, "Tags", "First", "Tag")
                        GUIContainer:AddChild(FirstTagText)
                        ...
                        GUIContainer:AddChild(FirstTagDropdownInfoTag)
                        ...
                        GUIContainer:AddChild(FirstTagHealthDropdown)
                        ...
                        GUIContainer:AddChild(FirstTagPowerDropdown)
                        ...
                        GUIContainer:AddChild(FirstTagNameDropdown)
                        ...
                        GUIContainer:AddChild(FirstTagMiscDropdown)
                        GUIContainer:DoLayout()
                    end
                    local function DrawSecondTagContainer()
                        ...
                        GUIContainer:AddChild(SecondTagOffsetX)
                        ...
                        GUIContainer:AddChild(SecondTagOffsetY)
                        ...
                        GUIContainer:AddChild(SecondTagFontSize)
                        ...
                        GUIContainer:AddChild(SecondTagColour)

                        local SecondTagText = CreateTag("Tag", Tags.Second.Tag, unit, "Tags", "Second", "Tag")
                        GUIContainer:AddChild(SecondTagText)
                        ...
                        GUIContainer:AddChild(SecondTagDropdownInfoTag)
                        ...
                        GUIContainer:AddChild(SecondTagHealthDropdown)
                        ...
                        GUIContainer:AddChild(SecondTagPowerDropdown)
                        ...
                        GUIContainer:AddChild(SecondTagNameDropdown)
                        ...
                        GUIContainer:AddChild(SecondTagMiscDropdown)
                        GUIContainer:DoLayout()
                    end
                    local function DrawThirdTagContainer()
                        ...
                        GUIContainer:AddChild(ThirdTagOffsetX)
                        ...
                        GUIContainer:AddChild(ThirdTagOffsetY)
                        ...
                        GUIContainer:AddChild(ThirdTagFontSize)
                        ...
                        GUIContainer:AddChild(ThirdTagColour)

                        local ThirdTagText = CreateTag("Tag", Tags.Third.Tag, unit, "Tags", "Third", "Tag")
                        GUIContainer:AddChild(ThirdTagText)
                        ...
                        GUIContainer:AddChild(ThirdTagDropdownInfoTag)
                        ...
                        GUIContainer:AddChild(ThirdTagHealthDropdown)
                        ...
                        GUIContainer:AddChild(ThirdTagPowerDropdown)
                        ...
                        GUIContainer:AddChild(ThirdTagNameDropdown)
                        ...
                        GUIContainer:AddChild(ThirdTagMiscDropdown)
                        GUIContainer:DoLayout()
                    end
                    local function DrawFourthTagContainer()
                        ...
                        GUIContainer:AddChild(FourthTagOffsetX)
                        ...
                        GUIContainer:AddChild(FourthTagOffsetY)
                        ...
                        GUIContainer:AddChild(FourthTagFontSize)
                        ...
                        GUIContainer:AddChild(FourthTagColour)

                        local FourthTagText = CreateTag("Tag", Tags.Fourth.Tag, unit, "Tags", "Fourth", "Tag")
                        GUIContainer:AddChild(FourthTagText)
                        ...
                        GUIContainer:AddChild(FourthTagDropdownInfoTag)
                        ...
                        GUIContainer:AddChild(FourthTagHealthDropdown)
                        ...
                        GUIContainer:AddChild(FourthTagPowerDropdown)
                        ...
                        GUIContainer:AddChild(FourthTagNameDropdown)
                        ...
                        GUIContainer:AddChild(FourthTagMiscDropdown)
                        GUIContainer:DoLayout()
                    end
            ...
            local function DrawIndicatorsContainer(GUIContainer)
                ...
                RaidMarkerContainer:SetTitle("Raid Marker |A:GM-raidMarker1:24:24|a")
                ...
                MouseoverHighlightContainer:SetTitle("Mouseover Highlight |A:Cursor_cast_64:24:24|a")
                ...
                if Indicators.Leader then
                    ...
                    LeaderContainer:SetTitle("Leader / Assistant |A:plunderstorm-glues-icon-leader:24:24|a")
                ...
                if isTarget then
                    ...
                    QuestContainer:SetTitle("Quest |A:AutoQuest-Badge-Campaign:24:24|a")
                ...
                if unit == "party" or unit == "raid" then
                    ...
                    RoleIconsContainer:SetTitle("Role Icons |A:GM-icon-roles:24:24|a")
                    ...
                    ReadyCheckContainer:SetTitle("Ready Check |A:UI-LFG-ReadyMark:24:24|a")
                    ...
                    SummonIndicatorContainer:SetTitle("Summon Indicator |A:Raid-Icon-SummonPending:24:24|a")
                ...
                if Indicators.TargetIndicator then
                    ...
                    TargetIndicatorContainer:SetTitle("Target Indicator |A:cursor_crosshairs_64:24:24|a")
