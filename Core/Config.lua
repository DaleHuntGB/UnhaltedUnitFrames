    ...
    function SelectedGroup(GUIContainer, _, mainGroup)
        ...
        local function DrawUnitContainer(GUIContainer, unit)
            ...
            local function DrawIndicatorsContainer(GUIContainer)
                ...
                RaidMarkerContainer:SetTitle("|A:GM-raidMarker1:24:24|aRaid Marker")
                ...
                MouseoverHighlightContainer:SetTitle("|A:Cursor_cast_64:24:24|aMouseover Highlight")
                ...
                if Indicators.Leader then
                    ...
                    LeaderContainer:SetTitle("|A:plunderstorm-glues-icon-leader:24:24|aLeader / Assistant")
                ...
                if isPlayer then
                    ...
                    StatusContainer:SetTitle("|TInterface\\CharacterFrame\\UI-StateIcon:24:24:0:0:64:64:0:32:0:27|tCombat / Resting")
                ...
                if isTarget then
                    ...
                    QuestContainer:SetTitle("|A:AutoQuest-Badge-Campaign:24:24|aQuest")
                ...
                if unit == "party" or unit == "raid" then
                    ...
                    RoleIconsContainer:SetTitle("|A:GM-icon-roles:24:24|aRole Icons")
                    ...
                    ReadyCheckContainer:SetTitle("|A:UI-LFG-ReadyMark:24:24|aReady Check")
                    ...
                    SummonIndicatorContainer:SetTitle("|A:Raid-Icon-SummonPending:24:24|aSummon Indicator")
