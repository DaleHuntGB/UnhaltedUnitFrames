...
local function CreateTextureSettings(containerParent)
    ...
    ForegroundTextureDropdown:SetRelativeWidth(0.33)
    ...
    BackgroundTextureDropdown:SetRelativeWidth(0.33)
    ...
    MouseoverStyleDropdown:SetRelativeWidth(0.33)
    ...
    MouseoverStyleDropdown:SetCallback("OnEnter", function() GameTooltip:SetOwner(MouseoverStyleDropdown.frame, "ANCHOR_CURSOR") GameTooltip:AddLine("Set |cFF8080FFMouseover Highlight Style|r for all units.\n|cFF8080FFColour|r & |cFF8080FFAlpha|r can be adjusted per unit.", 1, 1, 1, false) GameTooltip:Show() end)
...
local function CreateAuraSettings(containerParent, unit)
    local CooldownTextContainer = UUFG.CreateInlineGroup(containerParent, "Cooldown Text Settings")

    local ColourPicker = AG:Create("ColorPicker")
    ColourPicker:SetLabel("Cooldown Text Colour")
    ColourPicker:SetColor(UUF.db.profile.Units[unit].Auras.CooldownText.Colour[1], UUF.db.profile.Units[unit].Auras.CooldownText.Colour[2], UUF.db.profile.Units[unit].Auras.CooldownText.Colour[3], 1)
    ColourPicker:SetCallback("OnValueChanged", function(_, _, r, g, b) UUF.db.profile.Units[unit].Auras.CooldownText.Colour = {r, g, b} if unit == "boss" then UUF:UpdateBossFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, "CooldownText") end end)
    ColourPicker:SetHasAlpha(false)
    ColourPicker:SetRelativeWidth(0.5)
    ...
    ScaleByIconSizeCheckbox:SetValue(UUF.db.profile.Units[unit].Auras.CooldownText.ScaleByIconSize)
    ScaleByIconSizeCheckbox:SetCallback("OnValueChanged", function(_, _, value) UUF.db.profile.Units[unit].Auras.CooldownText.ScaleByIconSize = value if unit == "boss" then UUF:UpdateBossFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, "CooldownText") end end)
    ...
    AnchorFromDropdown:SetList(AnchorPoints[1], AnchorPoints[2])
    AnchorFromDropdown:SetLabel("Anchor From")
    AnchorFromDropdown:SetValue(UUF.db.profile.Units[unit].Auras.CooldownText.Layout[1])
    AnchorFromDropdown:SetRelativeWidth(0.5)
    AnchorFromDropdown:SetCallback("OnValueChanged", function(_, _, value) UUF.db.profile.Units[unit].Auras.CooldownText.Layout[1] = value if unit == "boss" then UUF:UpdateBossFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, "CooldownText") end end)
    CooldownTextContainer:AddChild(AnchorFromDropdown)

    local AnchorToDropdown = AG:Create("Dropdown")
    AnchorToDropdown:SetList(AnchorPoints[1], AnchorPoints[2])
    AnchorToDropdown:SetLabel("Anchor To")
    AnchorToDropdown:SetValue(UUF.db.profile.Units[unit].Auras.CooldownText.Layout[2])
    AnchorToDropdown:SetRelativeWidth(0.5)
    AnchorToDropdown:SetCallback("OnValueChanged", function(_, _, value) UUF.db.profile.Units[unit].Auras.CooldownText.Layout[2] = value if unit == "boss" then UUF:UpdateBossFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, "CooldownText") end end)
    CooldownTextContainer:AddChild(AnchorToDropdown)

    local XPosSlider = AG:Create("Slider")
    XPosSlider:SetLabel("X Position")
    XPosSlider:SetValue(UUF.db.profile.Units[unit].Auras.CooldownText.Layout[3])
    XPosSlider:SetSliderValues(-1000, 1000, 0.1)
    XPosSlider:SetRelativeWidth(0.33)
    XPosSlider:SetCallback("OnValueChanged", function(_, _, value) UUF.db.profile.Units[unit].Auras.CooldownText.Layout[3] = value if unit == "boss" then UUF:UpdateBossFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, "CooldownText") end end)
    CooldownTextContainer:AddChild(XPosSlider)

    local YPosSlider = AG:Create("Slider")
    YPosSlider:SetLabel("Y Position")
    YPosSlider:SetValue(UUF.db.profile.Units[unit].Auras.CooldownText.Layout[4])
    YPosSlider:SetSliderValues(-1000, 1000, 0.1)
    YPosSlider:SetRelativeWidth(0.33)
    YPosSlider:SetCallback("OnValueChanged", function(_, _, value) UUF.db.profile.Units[unit].Auras.CooldownText.Layout[4] = value if unit == "boss" then UUF:UpdateBossFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, "CooldownText") end end)
    CooldownTextContainer:AddChild(YPosSlider)

    local FontSizeSlider = AG:Create("Slider")
    FontSizeSlider:SetLabel("Font Size")
    FontSizeSlider:SetValue(UUF.db.profile.Units[unit].Auras.CooldownText.FontSize)
    FontSizeSlider:SetSliderValues(8, 64, 1)
    FontSizeSlider:SetRelativeWidth(0.33)
    FontSizeSlider:SetCallback("OnValueChanged", function(_, _, value) UUF.db.profile.Units[unit].Auras.CooldownText.FontSize = value if unit == "boss" then UUF:UpdateBossFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, "CooldownText") end end)
