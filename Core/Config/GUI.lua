...
local function CreatePowerBarSettings(containerParent, unit, updateCallback)
    ...
    local AttachedToggle = AG:Create("CheckBox")
    AttachedToggle:SetLabel("Attached on unit")
    AttachedToggle:SetValue(PowerBarDB.Attached)
    AttachedToggle:SetCallback("OnValueChanged", function(_, _, value) PowerBarDB.Attached = value updateCallback() RefreshPowerBarGUI() end)
    AttachedToggle:SetRelativeWidth(0.25)
    LayoutContainer:AddChild(AttachedToggle)

    local MatchParentWidthToggle = AG:Create("CheckBox")
    MatchParentWidthToggle:SetLabel("Match Frame Width")
    MatchParentWidthToggle:SetValue(PowerBarDB.MatchParentWidth)
    MatchParentWidthToggle:SetCallback("OnValueChanged", function(_, _, value) PowerBarDB.MatchParentWidth = value updateCallback() RefreshPowerBarGUI() end)
    MatchParentWidthToggle:SetRelativeWidth(0.25)
    MatchParentWidthToggle:SetDisabled(PowerBarDB.Attached)
    LayoutContainer:AddChild(MatchParentWidthToggle)
    ...
    local WidthSlider = AG:Create("Slider")
    WidthSlider:SetLabel("Width")
    WidthSlider:SetValue(PowerBarDB.Width)
    WidthSlider:SetSliderValues(1, 1000, 0.1)
    WidthSlider:SetRelativeWidth(0.5)
    WidthSlider:SetCallback("OnValueChanged", function(_, _, value) PowerBarDB.Width = value updateCallback() end)
    WidthSlider:SetDisabled(PowerBarDB.Attached)
    LayoutContainer:AddChild(WidthSlider)
    ...
    AnchorFromDropdown:SetList(AnchorPoints[1], AnchorPoints[2])
    AnchorFromDropdown:SetLabel("Anchor From")
    AnchorFromDropdown:SetValue(PowerBarDB.Layout[1])
    AnchorFromDropdown:SetRelativeWidth(0.5)
    AnchorFromDropdown:SetCallback("OnValueChanged", function(_, _, value) PowerBarDB.Layout[1] = value updateCallback() end)
    AnchorFromDropdown:SetDisabled(PowerBarDB.Attached)
    LayoutContainer:AddChild(AnchorFromDropdown)

    local AnchorToDropdown = AG:Create("Dropdown")
    AnchorToDropdown:SetList(AnchorPoints[1], AnchorPoints[2])
    AnchorToDropdown:SetLabel("Anchor To")
    AnchorToDropdown:SetValue(PowerBarDB.Layout[2])
    AnchorToDropdown:SetRelativeWidth(0.5)
    AnchorToDropdown:SetCallback("OnValueChanged", function(_, _, value) PowerBarDB.Layout[2] = value updateCallback() end)
    AnchorToDropdown:SetDisabled(PowerBarDB.Attached)
    LayoutContainer:AddChild(AnchorToDropdown)

    local XPosSlider = AG:Create("Slider")
    XPosSlider:SetLabel("X Position")
    XPosSlider:SetValue(PowerBarDB.Layout[3])
    XPosSlider:SetSliderValues(-1000, 1000, 0.1)
    XPosSlider:SetRelativeWidth(0.33)
    XPosSlider:SetCallback("OnValueChanged", function(_, _, value) PowerBarDB.Layout[3] = value updateCallback() end)
    XPosSlider:SetDisabled(PowerBarDB.Attached)
    LayoutContainer:AddChild(XPosSlider)

    local YPosSlider = AG:Create("Slider")
    YPosSlider:SetLabel("Y Position")
    YPosSlider:SetValue(PowerBarDB.Layout[4])
    YPosSlider:SetSliderValues(-1000, 1000, 0.1)
    YPosSlider:SetRelativeWidth(0.33)
    YPosSlider:SetCallback("OnValueChanged", function(_, _, value) PowerBarDB.Layout[4] = value updateCallback() end)
    YPosSlider:SetDisabled(PowerBarDB.Attached)
    LayoutContainer:AddChild(YPosSlider)

    local FrameStrataDropdown = AG:Create("Dropdown")
    FrameStrataDropdown:SetList(FrameStrataList[1], FrameStrataList[2])
    FrameStrataDropdown:SetLabel("Frame Strata")
    FrameStrataDropdown:SetValue(PowerBarDB.FrameStrata)
    FrameStrataDropdown:SetRelativeWidth(0.33)
    FrameStrataDropdown:SetCallback("OnValueChanged", function(_, _, value) PowerBarDB.FrameStrata = value updateCallback() end)
    FrameStrataDropdown:SetDisabled(PowerBarDB.Attached)
    LayoutContainer:AddChild(FrameStrataDropdown)
