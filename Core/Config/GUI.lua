...
local function CreateFrameSettings(containerParent, unit, unitHasParent, updateCallback)
    ...
    if unit == "boss" or unit == "party" then
        ...
        GrowthDirectionDropdown:SetList({["UP"] = "Up", ["DOWN"] = "Down", ["LEFT"] = "Left", ["RIGHT"] = "Right"})
...
local function CreateHealPredictionSettings(containerParent, unit, updateCallback)
    ...
    AbsorbHeightSlider:SetDisabled(HealPredictionDB.Absorbs.MatchParentHeight or HealPredictionDB.Absorbs.Position == "ATTACH" or HealPredictionDB.Absorbs.Position == "OVERLAY")
    AbsorbSettings:AddChild(AbsorbHeightSlider)

    local AbsorbPositionDropdown = AG:Create("Dropdown")
    AbsorbPositionDropdown:SetList({["TOPLEFT"] = "Top Left", ["TOPRIGHT"] = "Top Right", ["BOTTOMLEFT"] = "Bottom Left", ["BOTTOMRIGHT"] = "Bottom Right", ["LEFT"] = "Left", ["RIGHT"] = "Right", ["ATTACH"] = "Attach To Missing Health", ["OVERLAY"] = "Overlay"}, {"TOPLEFT", "TOPRIGHT", "BOTTOMLEFT", "BOTTOMRIGHT", "LEFT", "RIGHT", "ATTACH", "OVERLAY"})
    ...
    local R3, G3, B3, A3 = unpack(HealPredictionDB.Incoming.Colour)
    IncomingHealColourPicker:SetColor(R3, G3, B3, A3)
    IncomingHealColourPicker:SetCallback("OnValueChanged", function(_, _, r, g, b, a) HealPredictionDB.Incoming.Colour = {r, g, b, a} updateCallback() end)
    ...
    IncomingHealHeightSlider:SetValue(HealPredictionDB.Incoming.Height)
    IncomingHealHeightSlider:SetSliderValues(1, FrameDB.Height - 2, 0.1)
    IncomingHealHeightSlider:SetRelativeWidth(0.33)
    IncomingHealHeightSlider:SetCallback("OnValueChanged", function(_, _, value) HealPredictionDB.Incoming.Height = value updateCallback() end)
    IncomingHealHeightSlider:SetDisabled(HealPredictionDB.Incoming.MatchParentHeight or HealPredictionDB.Incoming.Position == "ATTACH")
    ...
    IncomingHealPositionDropdown:SetCallback("OnValueChanged", function(_, _, value) HealPredictionDB.Incoming.Position = value updateCallback() RefreshHealPredictionSettings() end)
    ...
    function RefreshHealPredictionSettings()
        ...
        GUIWidgets.DeepDisable(IncomingHealSettings, not HealPredictionDB.Incoming.Enabled, ShowIncomingHealToggle)
        AbsorbHeightSlider:SetDisabled(HealPredictionDB.Absorbs.MatchParentHeight or HealPredictionDB.Absorbs.Position == "ATTACH" or HealPredictionDB.Absorbs.Position == "OVERLAY")
        HealAbsorbHeightSlider:SetDisabled(HealPredictionDB.HealAbsorbs.MatchParentHeight or HealPredictionDB.HealAbsorbs.Position == "ATTACH")
        IncomingHealHeightSlider:SetDisabled(HealPredictionDB.Incoming.MatchParentHeight or HealPredictionDB.Incoming.Position == "ATTACH")
    end
...
local function CreateRoleIndicatorSettings(containerParent, unit, updateCallback)
    ...
    Toggle:SetCallback("OnValueChanged", function(_, _, value) RoleDB.Enabled = value updateCallback() RefreshRoleIndicatorGUI() end)
    Toggle:SetRelativeWidth(0.5)
    ToggleContainer:AddChild(Toggle)
    ...
    function RefreshRoleIndicatorGUI()
...
local function CreateSummonIndicatorSettings(containerParent, unit, updateCallback)
    ...
    Toggle:SetCallback("OnValueChanged", function(_, _, value) SummonDB.Enabled = value updateCallback() RefreshSummonIndicatorGUI() end)
    Toggle:SetRelativeWidth(0.5)
    ToggleContainer:AddChild(Toggle)
    ...
    function RefreshSummonIndicatorGUI()
...
local function CreatePhaseIndicatorSettings(containerParent, unit, updateCallback)
    ...
    Toggle:SetCallback("OnValueChanged", function(_, _, value) PhaseDB.Enabled = value updateCallback() RefreshPhaseIndicatorGUI() end)
    Toggle:SetRelativeWidth(0.5)
    ToggleContainer:AddChild(Toggle)
    ...
    function RefreshPhaseIndicatorGUI()
...
local function CreateTagSetting(containerParent, unit, tagDB)
    ...
    EditBox:SetCallback("OnEnterPressed", function(_, _, value) TagDB.Tag = value EditBox:SetText(TagDB.Tag) if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() else UUF:UpdateUnitTag(UUF[unit:upper()], unit, tagDB) end end)
    ...
    ColourPicker:SetCallback("OnValueChanged", function(_, _, r, g, b) TagDB.Colour = {r, g, b} if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() else UUF:UpdateUnitTag(UUF[unit:upper()], unit, tagDB) end end)
    ColourPicker:SetHasAlpha(false)
    ColourPicker:SetRelativeWidth(0.5)
    ...
    AnchorFromDropdown:SetRelativeWidth(0.5)
    AnchorFromDropdown:SetCallback("OnValueChanged", function(_, _, value) TagDB.Layout[1] = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() else UUF:UpdateUnitTag(UUF[unit:upper()], unit, tagDB) end end)
    LayoutContainer:AddChild(AnchorFromDropdown)
    ...
    AnchorToDropdown:SetRelativeWidth(0.5)
    AnchorToDropdown:SetCallback("OnValueChanged", function(_, _, value) TagDB.Layout[2] = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() else UUF:UpdateUnitTag(UUF[unit:upper()], unit, tagDB) end end)
    LayoutContainer:AddChild(AnchorToDropdown)
    ...
    XPosSlider:SetSliderValues(-1000, 1000, 0.1)
    XPosSlider:SetRelativeWidth(0.33)
    XPosSlider:SetCallback("OnValueChanged", function(_, _, value) TagDB.Layout[3] = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() else UUF:UpdateUnitTag(UUF[unit:upper()], unit, tagDB) end end)
    LayoutContainer:AddChild(XPosSlider)
    ...
    YPosSlider:SetSliderValues(-1000, 1000, 0.1)
    YPosSlider:SetRelativeWidth(0.33)
    YPosSlider:SetCallback("OnValueChanged", function(_, _, value) TagDB.Layout[4] = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() else UUF:UpdateUnitTag(UUF[unit:upper()], unit, tagDB) end end)
    LayoutContainer:AddChild(YPosSlider)
    ...
    FontSizeSlider:SetSliderValues(8, 64, 1)
    FontSizeSlider:SetRelativeWidth(0.33)
    FontSizeSlider:SetCallback("OnValueChanged", function(_, _, value) TagDB.FontSize = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() else UUF:UpdateUnitTag(UUF[unit:upper()], unit, tagDB) end end)
    ...
    HealthTagDropdown:SetCallback("OnValueChanged", function(_, _, value) local currentTag = TagDB.Tag if currentTag and currentTag ~= "" then currentTag = currentTag .. "[" .. value .. "]" else currentTag = "[" .. value .. "]" end EditBox:SetText(currentTag) UUF.db.profile.Units[unit].Tags[tagDB].Tag = currentTag if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() else UUF:UpdateUnitTag(UUF[unit:upper()], unit, tagDB) end HealthTagDropdown:SetValue(nil) end)
...
local function CreateSpecificAuraSettings(containerParent, unit, auraDB)
    ...
    Toggle:SetCallback("OnValueChanged", function(_, _, value) AuraDB.Enabled = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() elseif unit == "raid" then UUF:UpdateRaidFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, auraDB) end RefreshAuraGUI() end)
    Toggle:SetRelativeWidth(0.33)
    ...
    -- OnlyShowPlayerToggle:SetCallback("OnValueChanged", function(_, _, value) AuraDB.OnlyShowPlayer = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, auraDB) end end)
    ...
    ShowTypeCheckbox:SetCallback("OnValueChanged", function(_, _, value) AuraDB.ShowType = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() elseif unit == "raid" then UUF:UpdateRaidFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, auraDB) end end)
    ...
    AnchorFromDropdown:SetRelativeWidth(0.5)
    AnchorFromDropdown:SetCallback("OnValueChanged", function(_, _, value) AuraDB.Layout[1] = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() elseif unit == "raid" then UUF:UpdateRaidFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, auraDB) end end)
    LayoutContainer:AddChild(AnchorFromDropdown)
    ...
    AnchorToDropdown:SetRelativeWidth(0.5)
    AnchorToDropdown:SetCallback("OnValueChanged", function(_, _, value) AuraDB.Layout[2] = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() elseif unit == "raid" then UUF:UpdateRaidFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, auraDB) end end)
    LayoutContainer:AddChild(AnchorToDropdown)
    ...
    XPosSlider:SetCallback("OnValueChanged", function(_, _, value) AuraDB.Layout[3] = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() elseif unit == "raid" then UUF:UpdateRaidFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, auraDB) end end)
    LayoutContainer:AddChild(XPosSlider)
    ...
    YPosSlider:SetCallback("OnValueChanged", function(_, _, value) AuraDB.Layout[4] = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() elseif unit == "raid" then UUF:UpdateRaidFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, auraDB) end end)
    LayoutContainer:AddChild(YPosSlider)
    ...
    SizeSlider:SetCallback("OnValueChanged", function(_, _, value) AuraDB.Size = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() elseif unit == "raid" then UUF:UpdateRaidFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, auraDB) end end)
    LayoutContainer:AddChild(SizeSlider)
    ...
    SpacingSlider:SetRelativeWidth(0.25)
    SpacingSlider:SetCallback("OnValueChanged", function(_, _, value) AuraDB.Layout[5] = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() elseif unit == "raid" then UUF:UpdateRaidFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, auraDB) end end)
    LayoutContainer:AddChild(SpacingSlider)
    ...
    NumAurasSlider:SetCallback("OnValueChanged", function(_, _, value) AuraDB.Num = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() elseif unit == "raid" then UUF:UpdateRaidFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, auraDB) end end)
    ...
    PerRowSlider:SetCallback("OnValueChanged", function(_, _, value) AuraDB.Wrap = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() elseif unit == "raid" then UUF:UpdateRaidFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, auraDB) end end)
    ...
    GrowthDirectionDropdown:SetCallback("OnValueChanged", function(_, _, value) AuraDB.GrowthDirection = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() elseif unit == "raid" then UUF:UpdateRaidFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, auraDB) end end)
    LayoutContainer:AddChild(GrowthDirectionDropdown)
    ...
    WrapDirectionDropdown:SetCallback("OnValueChanged", function(_, _, value) AuraDB.WrapDirection = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() elseif unit == "raid" then UUF:UpdateRaidFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, auraDB) end end)
    ...
    CountAnchorFromDropdown:SetCallback("OnValueChanged", function(_, _, value) AuraDB.Count.Layout[1] = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() elseif unit == "raid" then UUF:UpdateRaidFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, auraDB) end end)
    ...
    CountAnchorToDropdown:SetCallback("OnValueChanged", function(_, _, value) AuraDB.Count.Layout[2] = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() elseif unit == "raid" then UUF:UpdateRaidFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, auraDB) end end)
    ...
    CountXPosSlider:SetCallback("OnValueChanged", function(_, _, value) AuraDB.Count.Layout[3] = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() elseif unit == "raid" then UUF:UpdateRaidFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, auraDB) end end)
    ...
    CountYPosSlider:SetCallback("OnValueChanged", function(_, _, value) AuraDB.Count.Layout[4] = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() elseif unit == "raid" then UUF:UpdateRaidFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, auraDB) end end)
    ...
    FontSizeSlider:SetCallback("OnValueChanged", function(_, _, value) AuraDB.Count.FontSize = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() elseif unit == "raid" then UUF:UpdateRaidFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, auraDB) end end)
    ...
    ColourPicker:SetCallback("OnValueChanged", function(_, _, r, g, b) AuraDB.Count.Colour = {r, g, b} if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() elseif unit == "raid" then UUF:UpdateRaidFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, auraDB) end end)
    ColourPicker:SetHasAlpha(false)
...
local function CreateAuraSettings(containerParent, unit)
    ...
    ColourPicker:SetCallback("OnValueChanged", function(_, _, r, g, b) UUF.db.profile.Units[unit].Auras.AuraDuration.Colour = {r, g, b} if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() elseif unit == "raid" then UUF:UpdateRaidFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, "AuraDuration") end end)
    ColourPicker:SetHasAlpha(false)
    ColourPicker:SetRelativeWidth(0.5)
    ...
    ScaleByIconSizeCheckbox:SetCallback("OnValueChanged", function(_, _, value) UUF.db.profile.Units[unit].Auras.AuraDuration.ScaleByIconSize = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() elseif unit == "raid" then UUF:UpdateRaidFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, "AuraDuration") end RefreshFontSizeSlider() end)
    ScaleByIconSizeCheckbox:SetRelativeWidth(0.5)
    ...
    AnchorFromDropdown:SetRelativeWidth(0.5)
    AnchorFromDropdown:SetCallback("OnValueChanged", function(_, _, value) UUF.db.profile.Units[unit].Auras.AuraDuration.Layout[1] = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() elseif unit == "raid" then UUF:UpdateRaidFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, "AuraDuration") end end)
    ...
    AnchorToDropdown:SetRelativeWidth(0.5)
    AnchorToDropdown:SetCallback("OnValueChanged", function(_, _, value) UUF.db.profile.Units[unit].Auras.AuraDuration.Layout[2] = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() elseif unit == "raid" then UUF:UpdateRaidFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, "AuraDuration") end end)
    ...
    XPosSlider:SetSliderValues(-1000, 1000, 0.1)
    XPosSlider:SetRelativeWidth(0.33)
    XPosSlider:SetCallback("OnValueChanged", function(_, _, value) UUF.db.profile.Units[unit].Auras.AuraDuration.Layout[3] = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() elseif unit == "raid" then UUF:UpdateRaidFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, "AuraDuration") end end)
    ...
    YPosSlider:SetSliderValues(-1000, 1000, 0.1)
    YPosSlider:SetRelativeWidth(0.33)
    YPosSlider:SetCallback("OnValueChanged", function(_, _, value) UUF.db.profile.Units[unit].Auras.AuraDuration.Layout[4] = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() elseif unit == "raid" then UUF:UpdateRaidFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, "AuraDuration") end end)
    ...
    FontSizeSlider:SetSliderValues(8, 64, 1)
    FontSizeSlider:SetRelativeWidth(0.33)
    FontSizeSlider:SetCallback("OnValueChanged", function(_, _, value) UUF.db.profile.Units[unit].Auras.AuraDuration.FontSize = value if unit == "boss" then UUF:UpdateBossFrames() elseif unit == "party" then UUF:UpdatePartyFrames() elseif unit == "raid" then UUF:UpdateRaidFrames() else UUF:UpdateUnitAuras(UUF[unit:upper()], unit, "AuraDuration") end end)
