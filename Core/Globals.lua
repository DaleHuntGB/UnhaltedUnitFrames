...
UUF.QuestTextures = {
    ...
    QUEST1 = "Interface\\AddOns\\UnhaltedUnitFrames\\Media\\Textures\\Quest\\Quest01.png",
}
...
UUF.AURA_FILTERS = {
    Buffs = {
        ...
        {Key = "Player", Group = "Player", Title = "All", Desc = "Show every buff applied by the player or their vehicle."},
        {Key = "ImportantPlayer", Group = "Player", Title = "Important", Desc = "Show important buffs applied by the player."},
        {Key = "CrowdControlPlayer", Group = "Player", Title = "Crowd Control", Desc = "Show crowd-control buffs applied by the player."},
        {Key = "BigDefensivePlayer", Group = "Player", Title = "Big Defensive", Desc = "Show major defensive buffs applied by the player."},
        {Key = "ExternalDefensivePlayer", Group = "Player", Title = "External Defensive", Desc = "Show external defensive buffs applied by the player."},
        {Key = "RaidInCombatPlayer", Group = "Player", Title = "Raid in Combat", Desc = "Show player-cast buffs marked for raid frames while in combat."},
        {Key = "CancelablePlayer", Group = "Player", Title = "Cancelable", Desc = "Show cancelable buffs applied by the player."},
        {Key = "NotCancelablePlayer", Group = "Player", Title = "Not Cancelable", Desc = "Show non-cancelable buffs applied by the player."},
        {Key = "RaidPlayer", Group = "Player", Title = "Raid", Desc = "Show player-cast buffs marked for raid frames."},
        {Key = "Important", Group = "Other", Title = "Important", Desc = "Show important buffs applied by other units."},
        {Key = "CrowdControl", Group = "Other", Title = "Crowd Control", Desc = "Show crowd-control buffs applied by other units."},
        {Key = "BigDefensive", Group = "Other", Title = "Big Defensive", Desc = "Show major defensive buffs applied by other units."},
        {Key = "ExternalDefensive", Group = "Other", Title = "External Defensive", Desc = "Show external defensive buffs applied by other units."},
        {Key = "RaidInCombat", Group = "Other", Title = "Raid in Combat", Desc = "Show other-cast buffs marked for raid frames while in combat."},
        {Key = "Cancelable", Group = "Other", Title = "Cancelable", Desc = "Show cancelable buffs applied by other units."},
        {Key = "NotCancelable", Group = "Other", Title = "Not Cancelable", Desc = "Show non-cancelable buffs applied by other units."},
    ...
    Debuffs = {
        ...
        {Key = "CrowdControlPlayer", Group = "Player", Title = "Crowd Control", Desc = "Show crowd-control debuffs applied by the player."},
        {Key = "BigDefensivePlayer", Group = "Player", Title = "Big Defensive", Desc = "Show major defensive debuffs applied by the player."},
        {Key = "ExternalDefensivePlayer", Group = "Player", Title = "External Defensive", Desc = "Show external defensive debuffs applied by the player."},
        {Key = "RaidInCombatPlayer", Group = "Player", Title = "Raid in Combat", Desc = "Show player-cast debuffs marked for raid frames while in combat."},
        {Key = "CancelablePlayer", Group = "Player", Title = "Cancelable", Desc = "Show cancelable debuffs applied by the player."},
        {Key = "NotCancelablePlayer", Group = "Player", Title = "Not Cancelable", Desc = "Show non-cancelable debuffs applied by the player."},
        {Key = "RaidPlayer", Group = "Player", Title = "Raid", Desc = "Show player-cast debuffs marked for raid frames."},
        {Key = "Important", Group = "Other", Title = "Important", Desc = "Show important debuffs applied by other units."},
        {Key = "CrowdControl", Group = "Other", Title = "Crowd Control", Desc = "Show crowd-control debuffs applied by other units."},
        {Key = "BigDefensive", Group = "Other", Title = "Big Defensive", Desc = "Show major defensive debuffs applied by other units."},
        {Key = "ExternalDefensive", Group = "Other", Title = "External Defensive", Desc = "Show external defensive debuffs applied by other units."},
        {Key = "RaidInCombat", Group = "Other", Title = "Raid in Combat", Desc = "Show other-cast debuffs marked for raid frames while in combat."},
        {Key = "Cancelable", Group = "Other", Title = "Cancelable", Desc = "Show cancelable debuffs applied by other units."},
        {Key = "NotCancelable", Group = "Other", Title = "Not Cancelable", Desc = "Show non-cancelable debuffs applied by other units."},
