...
UUF.AURA_FILTERS = {
    Buffs = {
        ...
        {Key = "RaidInCombatPlayer", Group = "Player (You)", Title = "Raid in Combat", Desc = "Show player-cast buffs marked for raid frames while in combat."},
        ...
        {Key = "RaidInCombat", Group = "Others (Not You)", Title = "Raid in Combat", Desc = "Show other-cast buffs marked for raid frames while in combat."},
        {Key = "Cancelable", Group = "Others (Not You)", Title = "Cancelable", Desc = "Show cancelable buffs applied by other units."},
        {Key = "NotCancelable", Group = "Others (Not You)", Title = "Not Cancelable", Desc = "Show non-cancelable buffs applied by other units."},
    ...
    Debuffs = {
        ...
        {Key = "RaidInCombatPlayer", Group = "Player (You)", Title = "Raid in Combat", Desc = "Show player-cast debuffs marked for raid frames while in combat."},
        ...
        {Key = "RaidInCombat", Group = "Others (Not You)", Title = "Raid in Combat", Desc = "Show other-cast debuffs marked for raid frames while in combat."},
        {Key = "Cancelable", Group = "Others (Not You)", Title = "Cancelable", Desc = "Show cancelable debuffs applied by other units."},
        {Key = "NotCancelable", Group = "Others (Not You)", Title = "Not Cancelable", Desc = "Show non-cancelable debuffs applied by other units."},
        {Key = "Raid", Group = "Others (Not You)", Title = "Raid", Desc = "Show other-cast debuffs marked for raid frames."},
    }
}
