...
function UUF:CreateRaidUnitFrame(unitFrame, unit)
    ...
    UUF:CreateRaidReadyCheckIndicator(unitFrame, unit)
    UUF:CreateRaidResurrectIndicator(unitFrame, unit)
...
function UUF:UpdateRaidUnitFrame(unitFrame, unit)
    ...
    UUF:UpdateRaidReadyCheckIndicatorSettings(unitFrame, unit)
    UUF:UpdateRaidResurrectIndicatorSettings(unitFrame, unit)
