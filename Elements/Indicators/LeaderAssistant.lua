...
function UUF:CreateUnitLeaderAssistantIndicator(unitFrame, unit)
    ...
    if LeaderAssistantDB then
        local Leader = unitFrame.HighLevelContainer:CreateTexture(UUF:FetchFrameName(unit, unitFrame) .. "_LeaderIndicator", "OVERLAY")
        ...
        local Assistant = unitFrame.HighLevelContainer:CreateTexture(UUF:FetchFrameName(unit, unitFrame) .. "_AssistantIndicator", "OVERLAY")
