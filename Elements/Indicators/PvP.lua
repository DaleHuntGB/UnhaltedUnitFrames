...
function UUF:CreateUnitPvPIndicator(unitFrame, unit)
    ...
    local PvPIndicator = unitFrame.HighLevelContainer:CreateTexture(UUF:FetchFrameName(unit, unitFrame) .. "_PvPIndicator", "OVERLAY", nil, 1)
    ...
    PvPIndicator.Badge = unitFrame.HighLevelContainer:CreateTexture(UUF:FetchFrameName(unit, unitFrame) .. "_PvPIndicatorBadge", "OVERLAY")
