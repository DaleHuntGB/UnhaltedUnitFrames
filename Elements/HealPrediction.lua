...
local function CreateUnitAbsorbs(unitFrame, unit)
    ...
    if AbsorbDB.Position == "RIGHT" then
        AbsorbBar:SetPoint("TOPRIGHT", unitFrame, "TOPRIGHT", -1, -1)
        AbsorbBar:SetPoint("BOTTOMRIGHT", unitFrame, "BOTTOMRIGHT", -1, 1)
        AbsorbBar:SetReverseFill(true)
    else
        AbsorbBar:SetPoint("TOPLEFT", unitFrame, "TOPLEFT", 1, -1)
        AbsorbBar:SetPoint("BOTTOMLEFT", unitFrame, "BOTTOMLEFT", 1, 1)
...
local function CreateUnitHealAbsorbs(unitFrame, unit)
    ...
    if HealAbsorbDB.Position == "RIGHT" then
        HealAbsorbBar:SetPoint("TOPRIGHT", unitFrame, "TOPRIGHT", -1, -1)
        HealAbsorbBar:SetPoint("BOTTOMRIGHT", unitFrame, "BOTTOMRIGHT", -1, 1)
        HealAbsorbBar:SetReverseFill(true)
    else
        HealAbsorbBar:SetPoint("TOPLEFT", unitFrame, "TOPLEFT", 1, -1)
        HealAbsorbBar:SetPoint("BOTTOMLEFT", unitFrame, "BOTTOMLEFT", 1, 1)
...
function UUF:UpdateUnitHealPrediction(unitFrame, unit)
    ...
    if unitFrame.HealthPrediction then
        if AbsorbDB.Enabled then
            ...
            if AbsorbDB.Position == "RIGHT" then
                unitFrame.HealthPrediction.damageAbsorb:SetPoint("TOPRIGHT", unitFrame, "TOPRIGHT", -1, -1)
                unitFrame.HealthPrediction.damageAbsorb:SetPoint("BOTTOMRIGHT", unitFrame, "BOTTOMRIGHT", -1, 1)
                unitFrame.HealthPrediction.damageAbsorb:SetReverseFill(true)
            else
                unitFrame.HealthPrediction.damageAbsorb:SetPoint("TOPLEFT", unitFrame, "TOPLEFT", 1, -1)
                unitFrame.HealthPrediction.damageAbsorb:SetPoint("BOTTOMLEFT", unitFrame, "BOTTOMLEFT", 1, 1)
        ...
        if HealAbsorbDB.Enabled then
            ...
            if HealAbsorbDB.Position == "RIGHT" then
                unitFrame.HealthPrediction.healAbsorb:SetPoint("TOPRIGHT", unitFrame, "TOPRIGHT", -1, 1)
                unitFrame.HealthPrediction.healAbsorb:SetPoint("BOTTOMRIGHT", unitFrame, "BOTTOMRIGHT", -1, 1)
                unitFrame.HealthPrediction.healAbsorb:SetReverseFill(true)
            else
                unitFrame.HealthPrediction.healAbsorb:SetPoint("TOPLEFT", unitFrame, "TOPLEFT", 1, -1)
                unitFrame.HealthPrediction.healAbsorb:SetPoint("BOTTOMLEFT", unitFrame, "BOTTOMLEFT", 1, 1)
