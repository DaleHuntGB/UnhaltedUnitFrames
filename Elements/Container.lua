...
function UUF:CreateUnitContainer(unitFrame, unit)
    if not unitFrame.Container then
        unitFrame.Container = CreateFrame("Frame", UUF:FetchFrameName(unit, unitFrame) .. "_Container", unitFrame, "BackdropTemplate")
        ...
        if not unitFrame.HighLevelContainer then
            unitFrame.HighLevelContainer = CreateFrame("Frame", UUF:FetchFrameName(unit, unitFrame) .. "_HighLevelContainer", unitFrame)
