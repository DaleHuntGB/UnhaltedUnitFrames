...
local function UpdateUnitCastBar(self, event, unit)
    ...
    if self.CastBar then
        if CAST_START[event] then
            ...
            self.CastBar:SetScript("OnUpdate", function() local remainingDuration = castDuration:GetRemainingDuration() self.CastBar.Time:SetText(string.format("%.1f", remainingDuration)) end)
